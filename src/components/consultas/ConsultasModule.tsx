...
export const ConsultasModule: React.FC<ConsultasModuleProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top Header & Subtabs */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-cba-card flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full lg:w-auto">
          {/* Subtabs Switcher */}
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 p-1 rounded-xl border border-slate-200 dark:border-slate-700 overflow-x-auto no-scrollbar w-full sm:w-auto">
            {/* 1. Sábana de Notas */}
            <button
            ...
            >
              <GraduationCap className={`w-3.5 h-3.5 shrink-0 ${activeTab === 'BOLETIN' ? 'text-cyan-400' : 'text-slate-400'}`} />
            ...
            >
              <Clock className={`w-3.5 h-3.5 shrink-0 ${activeTab === 'ASISTENCIA' ? 'text-cyan-400' : 'text-slate-400'}`} />
