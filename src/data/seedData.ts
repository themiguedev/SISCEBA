...
export const INITIAL_STUDENTS: Student[] = [
  ...
  },
  {
    ...
    representativeEmail: 'representante@bellasartes.edu.ve',
...
export const INITIAL_USERS: AppUser[] = [
  ...
  },
  {
    ...
    fullName: 'Prof. Docente Titular CBA',
    email: 'docente@bellasartes.edu.ve',
    role: 'DOCENTE',
    defaultLevel: 'MEDIA_GENERAL',
    active: true,
  ...
  {
    id: 'usr-representante',
    username: 'representante',
    password: 'cba2026*representante',
    fullName: 'Padre y Representante Legal CBA',
    email: 'representante@bellasartes.edu.ve',
    role: 'REPRESENTANTE',
    defaultLevel: 'MEDIA_GENERAL',
    active: true,
  ...
  },
  {
    id: 'usr-estudiante',
    username: 'estudiante',
    password: 'cba2026*estudiante',
    fullName: 'Camila Isabella Urdaneta Moreno',
    email: 'estudiante@bellasartes.edu.ve',
    role: 'ESTUDIANTE',
    defaultLevel: 'MEDIA_GENERAL',
    active: true,
